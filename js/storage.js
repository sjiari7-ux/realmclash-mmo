...
async function buyListing(listingId){
  ...
  try{
    ...
    // best-effort credit to the seller (last-writer-wins on their own gold field) — fire-and-forget:
    // the buyer's own purchase already succeeded, so this shouldn't hold up their success message
    (async ()=>{
      try{
